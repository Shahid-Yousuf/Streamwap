...
const VideoProcessing = (key)=>{
      ...
      const getFolderPath = key.split('.')[0];
      console.log(getFolderPath)
      const destinationFolder = getFolderPath;
    const params = {
        "Settings": {
          "OutputGroups": [
            {
              ...
              "OutputGroupSettings": {
                ...
                "CmafGroupSettings": {
                  ...
                  "Destination": "s3://stream-wap-storage/stream/"+destinationFolder
                }
              }
            }
          ],
          ...
          "Inputs": [
            {
              ...
              "FileInput": "s3://stream-wap-storage/"+key
            }
          ],
          "FollowSource": 1
        },
        ...
        "Role": "arn:aws:iam::331778095806:role/service-role/MediaConvert_Default_Role"
      }
      return params;
}
